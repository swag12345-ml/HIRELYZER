COURSES_BY_CATEGORY = {
    "Software Development and Engineering": {
        ...
        "Full Stack Developer": [
            ...
            ["Full Stack Development with React & Node.js", "https://www.udemy.com/course/node-with-react-fullstack-web-development/"]
        ],
        ...
        "Game Developer": [
            ...
            ["Unity Certified Programmer Exam Preparation", "https://www.udemy.com/course/the-ultimate-unity-game-developer-course-from-zero-to-hero/"],
    ...
    "UI/UX Design": {
        "UI Designer": [
            ...
            ["UI Design Bootcamp", "https://www.udemy.com/course/learn-figma/"],
            ["Advanced UI Design Course", "https://www.udacity.com/course/ux-designer-nanodegree--nd578"],
            ["Design System Course", "https://www.designsystems.com/"]
        ],
        "UX Designer": [
            ["UX Design Course [Free]", "https://youtu.be/kbZejnPXyLM?si=A7uozhKWOe3rmubQ"],
    ...
    "Project Management": {
        ...
        "Product Manager": [
            ["Product Management Course [Free]", "https://www.youtube.com/live/y8siQJUk5xc?si=gelN-Tk_ZIYrWrTu"],
...
RESUME_VIDEOS = {
    "Resume Writing Tips": [
        ["How to Write a Resume That Stands Out", "https://youtu.be/ZwP7kv0zHiY?si=vx0VofAVxOq6rwhG"],
        ["Resume Writing for Beginners", "https://youtu.be/NcD3nufvA7Y?si=tqZ7A7Da8SINUb7m"],
        ["Top 10 Resume Mistakes to Avoid", "https://youtu.be/OtGIaoEOJUU?si=YpSlXHfEId5xWfeg"]
    ],
    "Resume Design": [
        ["Creative Resume Design Ideas", "https://youtu.be/sdqGLKQqMrA?si=ItK_91v1BXS31svU"],
        ["Best Resume Templates for 2025", "https://youtu.be/ZcuziWFfpQY?si=5O1IhN2CD38bTCGd"],
        ["How to Make Your Resume Look Professional", "https://youtu.be/XJ7bYdjKDcA?si=IUP6MF9piu3zHMXN"]
    ],
    "Resume Formats": [
        ["Chronological vs Functional Resume", "https://youtu.be/U2kZIuMWLD8?si=cQvoRvUuZTmus2QN"],
        ["Best Resume Format for Job Applications", "https://youtu.be/qhocVNbvNHs?si=4ce82y_YNHxCD_-E"],
        ["Resume Formats Explained", "https://youtu.be/VB376MMEq38?si=_1OpquX_ij3_IyVB"]
    ]
}
...
INTERVIEW_VIDEOS = {
    "Interview Tips": [
        ["Top 10 Interview Tips", "https://youtu.be/ZMByWenSRdI?si=jhU9BPLGoArpcIG2"],
        ["How to Prepare for a Job Interview", "https://youtu.be/LCWr-TJrc0k?si=bzlPm9qSgIJOfn6D"],
        ["Interview Questions and Answers", "https://youtu.be/gCrA-pFe7Zo?si=kpGYj2bddopmipxF"]
    ],
    "Technical Interview Preparation": [
        ["Cracking the Coding Interview", "https://youtu.be/OmFLoCYeZ4I?si=M_1GRdrm6j8zA_OS"],
        ["System Design Interview Prep", "https://youtu.be/l3X1t3kpmwY?si=jGZFQwsbuvFtyZ2Y"],
        ["Data Structures and Algorithms", "https://youtu.be/8hly31xKli0"]
    ],
    "Behavioral Interview": [
        ["Behavioral Interview Questions", "https://youtu.be/2uM7gYuOvr4?si=Fw-qppAAAAyvCxFa"],
        ["STAR Method for Interviews", "https://youtu.be/uQEuo7woEEk?si=wSr2Ids1WGkgnktc"],
        ["Answering Tough Interview Questions", "https://youtu.be/x0OYmpB0Yaw?si=DrQNIhOA1jaujgix"]
    ]
}

# ======= Helper Functions =======

def get_courses_for_role(category: str, role: str):
    """
    Get a list of courses for the given category and role.
    Returns an empty list if the category or role is not found.
    
    Args:
        category (str): The category name.
        role (str): The role/job title.
    
    Returns:
        list: A list of [course title, URL] pairs.
    """
    return COURSES_BY_CATEGORY.get(category, {}).get(role, [])
def get_all_course_recommendations():
    recommendations = []
