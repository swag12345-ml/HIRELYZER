...
st.markdown(
    ...
    .stButton > button {
        ...
        text-transform: uppercase; box-shadow: 0px 0px 12px #00ffff;
...
.hero {
  position: relative; width: 100%; height: 420px; border-radius: 28px; overflow: hidden;
  background:
...
.pill { padding: 6px 10px; border-radius: 999px; border: 1px solid rgba(255,255,255,.25);
...
.bag { width: 92px; height: 72px; border-radius: 18px 18px 8px 8px;
  ...
  animation: bag-enter 1.2s cubic-bezier(.2,.8,.2,1) 0s both, bag-slide 1.2s cubic-bezier(.2,.8,.2,1) 1.1s both; }
.bag:before { content: ""; position: absolute; left: 14px; right: 14px; top: -16px; height: 18px;
  background: linear-gradient(180deg, #c4b5fd, #8b5cf6); border-radius: 8px;
  box-shadow: 0 6px 14px rgba(59,130,246,.35); }
.bag:after { content: ""; position: absolute; left: 0; right: 0; top: 28px; height: 6px;
  background: rgba(255,255,255,.35); }
.lock { position: absolute; left: 50%; top: 36px; transform: translateX(-50%);
  width: 18px; height: 18px; border-radius: 6px;
  background: linear-gradient(180deg, #fde68a, #f59e0b);
  box-shadow: 0 6px 12px rgba(245,158,11,.35); }

.brand { font-family: 'Orbitron', sans-serif; font-weight: 900; font-size: 56px; letter-spacing: 2px;
  color: #ffffff; text-shadow: 0 0 8px rgba(255,255,255,0.6),0 0 16px rgba(255,255,255,0.4);
  opacity: 0; animation: brand-reveal 1.0s ease-out 1.75s both; }
.brand span { display: inline-block; transform: translateY(18px); opacity: 0; animation: letter 0.8s ease-out forwards; }
...
.statcard { position: absolute; right: 20px; bottom: 20px; padding: 14px; border-radius: 16px;
  background: var(--glass); border: 1px solid var(--glass-border); color: #e5e7eb; backdrop-filter: blur(8px);
...
.bar > i { display: block; height: 100%; width: 0;
  background: linear-gradient(90deg, #22d3ee, #818cf8); animation: fill 1.2s ease-out 2.0s forwards; }
...
st.components.v1.html(HIRELYZER_HTML, height=460)
