...
with tab2:
    ...
    with st.form("resume_form"):
        ...
        if st.form_submit_button("➕ Add Experience", type="secondary"):
        ...
        if st.form_submit_button("➕ Add Education", type="secondary"):
        ...
        if st.form_submit_button("➕ Add Certificate", type="secondary"):
